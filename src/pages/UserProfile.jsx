...
const UserProfile = () => {
  ...
  const loadUserData = async () => {
     try {
       ...
       // Atualizar o contexto de autenticação com os dados mais recentes
       if (response.data.picture) {
         const updatedUser = { ...user, picture: getAvatarUrl(response.data.picture) };
  ...
  const loadFinancialData = async () => {
    try {
      const response = await apiService.getFinancialTitles();
